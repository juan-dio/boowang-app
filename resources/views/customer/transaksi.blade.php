    ...
    <div class="container py-4 py-md-5 mb-5">
        ...
        <div class="row p-2 mb-2">
            <div class="col-md-8 mx-auto">
                <div class="row p-2 border rounded overflow-hidden shadow-sm align-items-center">
                    <div class="col-3 p-0 text-center fw-bold">
                        Transaksi
                    </div>
                    <div class="col-3 p-0 text-center fw-bold">
                        Wisata
                    </div>
                    <div class="col-2 p-0 text-center fw-bold">
                        Tiket
                    </div>
                    <div class="col-2 p-0 text-center fw-bold">
                        Jumlah
        ...
        @if ($transactions->count())
            @foreach ($transactions as $transaction)
                <div class="row px-2 mb-2" style="font-size: 0.8rem">
                    <div class="col-md-8 mx-auto">
                        <div class="row px-1 px-md-2 py-3 py-md-4 border rounded overflow-hidden shadow-sm align-items-center">
        ...
        <div class="row mt-4 mb-2 px-2">
            <div class="col-md-8 mx-auto g-0">
