...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-white text-center fs-4 fw-semibold" style="background-color: var(--bs-green)"><a href="{{ Route('home') }}" class="text-white text-decoration-none">Boo<span class="text-warning">Wang</span></a> {{ __('Change Password') }}</div>
                <div class="card-body">
